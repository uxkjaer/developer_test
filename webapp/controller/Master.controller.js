sap.ui.define([
	...
	return BaseController.extend("ns.project2.controller.Master", {
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "ns.project2.view.ViewSettingsDialog",
					controller: this
        ...
        /**
		 * Event handler for the Employees buttons to open the ViewEmployeeDetailsDialog.
		 * @param {sap.ui.base.Event} oEvent the button press event
		 * @public
		 */
		onOpenViewEmployeeDetails : function (oEvent) {
			...
			if (!this._pPopover) {
				this._pPopover = Fragment.load({
					id: oView.getId(),
					name: "ns.project2.view.QuickView",
					controller: this
            ...
            this._pPopover.then(function(oPopover) {
                ...
                var sPath = `${oCtx.getPath()}/Employee`;
        ...
        handleEmployeeDetailsClose: function (oEvent) {
